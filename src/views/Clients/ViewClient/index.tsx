    ...
    return (
        <div className="p-4 md:p-6 lg:p-8 bg-gray-100 min-h-screen">
            <Card bordered={false} className="w-full mx-auto">
                <h1 className="text-2xl md:text-3xl font-bold text-gray-700 mb-4 text-center">{t('client_data')}</h1>
                <Spin spinning={isLoading}>
                    <Form form={form} layout="vertical" autoComplete="off">
                        {/* Foydalanuvchi ma'lumotlari */}
                        <Row gutter={[16, 16]} className={"pointer-events-none"}>
                            ...
                            {(fields, {remove}) => (
                                <>
                                    {fields.map((field, index) => (
                                        ...
                                        >
                                            <Row gutter={[16, 16]}>
                                                <Col xs={24} lg={12} xl={8} className={"pointer-events-none"}>
                                                    <Form.Item
                                                        {...field}
                                                        label={t('full_name')}
